        ...
        <div className="pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32">
          <div className="px-6 lg:px-8">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              <h2 className="text-3xl font-bold tracking-tight text-ccDarkBlue border-b-2 border-ccLightBlue">Get in Touch</h2>
      ...
      >
        ...
        <option>Documentation</option>
                ...
                <div className="mt-10 flex justify-end border-t border-gray-900/10 pt-8">
                  <p>By submitting this form, I agree that the information entered will be used in line with my request for information and for the resulting business relationship, where applicable.</p>
                  <button
                    type="submit"
